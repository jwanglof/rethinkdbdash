...
function Connection(r, options, resolve, reject) {
  ...
  this.username = options.username || r._user;
  this.password = options.password || r._password;
  ...
  if (options.connection) {
    ...
    if (this.username !== r._user) {
      connectionArgs.username = this.username;
    }
    if (this.password !== r._password) {
      connectionArgs.password = this.password;
    }
